...
/**
 * Emplacement du dossier de stockage pour les photos de type employees
 */
export const UPLOAD_DIR_EMPLOYEES = path.join(ENV.STORAGE_DIR, "images", "employees");
/**
 * Emplacement du dossier de stockage pour les photos de type decorators
 */
export const UPLOAD_DIR_DECORATORS = path.join(ENV.STORAGE_DIR, "images", "decorators");
