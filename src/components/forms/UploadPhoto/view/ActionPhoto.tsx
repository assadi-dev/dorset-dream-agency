...
const ActionPhoto = ({ onEdit, onDelete }: ActionPhotoProps) => {
    return (
        <div className="group-hover:opacity-0 rounded-lg border border-white/50  bg-[#0f172a]/25  flex justify-between gap-2 items-center w-[90%] mx-auto p-1 absolute bottom-1.5    backdrop-blur-xl ">
