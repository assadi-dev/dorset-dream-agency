...
import GradeMoreAction from "./RoleMoreAction";
...
type ListRolesProps = {
    roles: { name: string; description: string; createdAt: string; updatedAt: string }[];
    limit: number;
    totalItems: number;
};
const ListeRoles = ({ roles, totalItems, limit }: ListRolesProps) => {
