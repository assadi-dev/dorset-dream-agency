    ...
    return (
        <div className="relative grid grid-rows-[auto_auto_1fr_auto] items-center justify-items-center min-h-screen  pb-20 gap-5 font-[family-name:var(--font-geist-sans)] pt-3 p-5 lg:px-12">
            ...
            <div className="my-5">
                ...
                <p className="block max-w-[45vw] mx-auto mb-8">
                ...
                <Card className="grid place-item-center w-[45vw] min-h-[12vh] p-5 mx-auto">
                ...
                <p className="block max-w-[45vw] mx-auto my-8">
                ...
                <p className="block max-w-[45vw] mx-auto my-8">
                    ...
                    dispositions, n’hésitez pas à nous en faire part. Cordialement, La direction Dorset Dream Agency 💫.
                </p>
            </div>
        </div>
    );
