            ...
            <div className="p-2 flex flex-col justify-between gap-3 relative">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between  p-2 rounded-sm backdrop-blur-md w-full gap-3">
                    ...
                    <Button
                        ...
                        variant={"default"}
                        type="button"
                        className="bg-gradient-to-br from-black to-primary !text-white lg:bg-background border hover:border-none hover:shadow-lg lg:hover:shadow-blue-950/50 border-input lg:text-black hover:bg-gradient-to-br   duration-300   transition-all  lg:hover:text-white text-xs lg:text-sm w-full lg:w-fit"
                    >
